...
public class ControllerRole2Home {
	 ...
	 * 
	 * <p> Description: This method sends the user to the page to view posts and replies </p>
	 */
	protected static void performViewPosts() {
		guiViewPosts.ViewPosts.displayAllPosts(ViewRole2Home.theStage, ViewRole2Home.theUser);
	}
